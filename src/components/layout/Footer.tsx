        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed text-gray-400 mb-6">
              ...
              Concessionnaire officiel Sea-Doo au Cap d&apos;Agde.
            </p>
            <div className="flex gap-3">
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white/5 text-gray-400 transition-all hover:bg-accent/90 hover:text-white"
              >
              ...
              <a
                href="https://www.facebook.com/matosimportbyjeff/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white/5 text-gray-400 transition-all hover:bg-accent/90 hover:text-white"
              ...
              <a
                href="https://www.tiktok.com/@matosimportbyjeff"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="TikTok"
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white/5 text-gray-400 transition-all hover:bg-accent/90 hover:text-white"
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-gray-400">
              ...
              <a
                href="mailto:matosimportbyjeff.34@gmail.com"
                className="flex items-center gap-2 transition-colors hover:text-white"
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                matosimportbyjeff.34@gmail.com
              </a>
              <p className="text-gray-600">Mar — Sam : 9h – 17h</p>
            </div>
          </div>
        </div>
